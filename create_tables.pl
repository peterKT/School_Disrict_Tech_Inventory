...
$query3 = "CREATE TABLE computers (computer_id SMALLINT(4) UNSIGNED NOT NULL AUTO_INCREMENT, model_id TINYINT(3) UNSIGNED NOT NULL, computer_name VARCHAR(24) NOT NULL DEFAULT 'Unknown', asset_tag VARCHAR(24) NOT NULL DEFAULT 'None', service_tag VARCHAR(16) NOT NULL DEFAULT 'Unknown', teacher_id SMALLINT(4) UNSIGNED NOT NULL DEFAULT '1', location_id SMALLINT(4) UNSIGNED NOT NULL, date_changed TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY (computer_id) )";
...
$query26 = "INSERT INTO teachers(last_name,first_name) VALUES('room info','See')";
