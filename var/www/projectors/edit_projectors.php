...
$query5 = "SELECT CONCAT(mf, ' ',model) AS model,model_id from manufacturers,projector_models WHERE manufacturers.mf_id=projector_models.mf_id AND projector_models.model_id != 20" ;
